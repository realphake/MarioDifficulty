...
import static ch.idsia.mario.engine.RandomLevel.lastSeed;
...
public class RandomLevel extends Level{
    ...
    protected static final byte BLOCK_COIN	= (byte) (4 + 1 + 1 * 16);
	    ...
	    {
                //System.out.println("");
                //System.out.println("RandomLevel.creat() called...");
                //System.out.println("-with levelSeed: " + seed);
                //System.out.println("-with levelDifficulty: " + difficulty);
                //System.out.println("-with levelType: " + type);
	        ...
	        odds[ODDS_CANNONS] = -10 + 5 * difficulty;
                ...
                //System.out.println("-odds[ODDS_STRAIGHT]: " + odds[ODDS_STRAIGHT]);
                //System.out.println("-odds[ODDS_HILL_STRAIGHT]: " + odds[ODDS_HILL_STRAIGHT]);
                //System.out.println("-odds[ODDS_TUBES]: " + odds[ODDS_TUBES]);
                //System.out.println("-odds[ODDS_JUMP]: " + odds[ODDS_JUMP]);
                //System.out.println("-odds[ODDS_CANNONS]: " + odds[ODDS_CANNONS]);
