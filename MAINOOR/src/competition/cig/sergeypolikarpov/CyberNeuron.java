...
public class CyberNeuron implements FA<double[], double[]>, Evolvable {
    ...
    public static int num_bits_in_input = 10; //****//
    public static int num_of_cells_in_sbox = (int) Math.pow(2, num_bits_in_input); //****//
    public static int [] powstwo = {1,2,4,8,16,32,64,128,256,512,1024,2048,4096,8192,16384,32768,65536};
    ...
    public static int num_of_trainings = 0;
    ...
    public CyberNeuron(int numberOfInputs, int numberOfOutputs) {
    	...
    	threshold_min = (int)(0.3*(127 * numberOfInputs*parallel_inputs/num_bits_in_input)); 
    ...
    private void mutate(char[] array) {
    }
    ...
    public void psoRecombine(CyberNeuron last, CyberNeuron pBest, CyberNeuron gBest) {
        // Learning of cyberneuron is already include random data, no need to recombining  
    }
